...
import { ProfileSchema, RegisterSchema, combinedRegisterSchema } from '@/lib/schemas/registerSchema';
...
export async function registerUser(registerSchema: RegisterSchema): Promise<ActionResult<User>> {
    try {
        const validated = combinedRegisterSchema.safeParse(registerSchema);
